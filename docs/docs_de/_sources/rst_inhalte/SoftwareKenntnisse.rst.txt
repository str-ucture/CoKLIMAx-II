...
* :ref:`Installation und Einrichten der notwendigen Software auf einem Windows-System <pythoninstall>`
* :ref:`Installation von Jupyter Notebooks <jupyterinstall>`
* :ref:`Starten des Jupyter Notebooks zur Vorbereitung auf die Kurs-Elemente <jupyterstart>`
...
1. Installation von Python oder Anaconda
