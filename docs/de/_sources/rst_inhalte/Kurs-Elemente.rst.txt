...
Jedes Element baut auf den vorherigen auf, sodass wir empfehlen, die Inhalte Schritt für Schritt durchzuarbeiten. Tauchen Sie ein und entdecken Sie, wie Jupyter Notebooks Ihnen dabei helfen können, Datenkompetenz für Ihre städtischen Verwaltungsprojekte aufzubauen! Haben Sie Ihren Computer bereits auf die Kurs-Ressourcen vorbereitet? Falls nicht, beginnen Sie beim Kapitel :ref:`Notwendige Software und Kenntnisse <software-to-run-jupyter>`. Ansonsten können Sie direkt zum Kurs 1 :ref:`Element 1 <kurs1-element1>` springen. 
