 ...
 * :ref:`Aufbau und Umgang mit einer Datei im NetCDF-Format<netcdfhowto>`
  * :ref:`Entpacken der NetCDF zip-Datei<netcdfunzip>`
  * :ref:`Untersuchen der NetCDF-Datei<netcdfinvestigate>`
 * :ref:`Visualisierung einer Zeitreihe und einer gewählten Region <netcdfvisualize>`
