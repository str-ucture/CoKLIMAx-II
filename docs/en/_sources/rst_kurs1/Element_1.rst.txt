...
Our sample dataset is the **ERA5 reanalysis dataset**. If you are already familiar with this dataset, you can skip the info box and proceed directly to the :ref:`next step <api_request>`.
